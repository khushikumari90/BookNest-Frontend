      ...
      <div class="orders-list" *ngIf="!loading && orders.length">
        <div class="order-card card" *ngFor="let o of orders">
          ...
          <div class="order-actions">
            <!-- Cancel Order: only for PLACED or CONFIRMED orders -->
            <button
              class="btn btn-danger btn-sm"
              *ngIf="canCancel(o.orderStatus)"
              (click)="cancelOrder(o)"
...
export class OrdersComponent implements OnInit {
  ...
  cancelOrder(order: Order) {
    ...
    this.orderSvc.changeStatus(order.orderId, 'CANCELLED').subscribe({
      next: () => {
      ...
      error: () => { this.cancellingId = null; alert('Could not cancel order. Please try again.'); }
    });
  }
