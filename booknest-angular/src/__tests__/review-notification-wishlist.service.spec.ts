...
import { ReviewService, NotificationService, WishlistService } from '../../../booknest_swagger/BookNest-Razorpay/frontend/booknest-angular/src/app/services/services';
...
describe('ReviewService', () => {
  ...
  it('should GET /api/reviews/all', () => {
    service.getAll().subscribe(reviews => expect(reviews.length).toBeGreaterThan(0));
    const req = httpMock.expectOne('/api/reviews/all');
    req.flush([mockReview]);
  });
...
describe('WishlistService', () => {
  ...
  it('should POST /api/wishlist/:userId/add to add a book', () => {
    ...
    const req = httpMock.expectOne('/api/wishlist/1/add');
    expect(req.request.method).toBe('POST');
